...
const features = [
  { icon: Image, title: "Choose Template", desc: "Pick from stunning poster designs" },
    ...
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden min-h-[60vh]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
          <h1 className="text-3xl md:text-6xl font-extrabold text-primary-foreground mb-3 animate-fade-in">
            Poster Generator
          </h1>
          <p className="text-base md:text-xl text-primary-foreground/90 mb-6 max-w-xl animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Create stunning posters in seconds. Upload your photo, add your name, and share with the world.
          </p>
          <Button
            size="lg"
            className="text-base px-6 py-4 bg-card text-primary font-bold hover:bg-card/90 shadow-lg animate-fade-in"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            {features.map((f, i) => (
              <div
                key={f.title}
                className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg bg-card shadow-sm border border-border animate-fade-in"
      ...
      <footer className="py-6 text-center text-muted-foreground text-xs md:text-sm border-t border-border">
